...
static __inline__ void Set_Size_And_Base_Pages(struct Segment_Descriptor* desc,
                                               ulong_t baseAddr,
                                               ulong_t numPages) {
    /*
...
static __inline__ void Set_Size_And_Base_Bytes(struct Segment_Descriptor* desc,
                                               ulong_t baseAddr,
                                               ulong_t numBytes) {
...
void Init_LDT_Descriptor(struct Segment_Descriptor* desc,
    ...
    Set_Size_And_Base_Bytes(desc, (ulong_t)theLDT,
                            sizeof(struct Segment_Descriptor) * numEntries);
